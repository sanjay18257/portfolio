...
import CV from "../../src/assets/sanjays.pdf";
const Data = () => {
  return (
    <div className="home_data">
      ...
      Passionate full-stack developer driven by innovation, constantly exploring new technologies to craft elegant solutions.
      </p>
      <a href="https://www.linkedin.com/in/sanjay-s-1a9719239/" className="button-hi">say hi
      <svg
                  class="button__icon"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
        ...
        <a download="" href={CV} className="pdf">Download CV
      <svg
                  class="button__icon"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
